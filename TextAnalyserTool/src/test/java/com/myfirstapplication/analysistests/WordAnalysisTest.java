...
public class WordAnalysisTest {
	 ...
	 * variables.
	 */
	public WordAnalysisTest(int testSelector, String fileLocation, String userInput, String propertiesForNLP,
			int paragraphCounter, int expectedResult1, String expectedResult2, String expectedResult3,
			int expectedResult4, int expectedResult5) {
		
		/*
		 * As the WordAnalysis class is instantiated in @Test methods, that class
	...
	public static Collection<Object[]> data() {
		return Arrays.asList(new Object[][] {
				...
				// Test case #0
				{ 1, "", "Hello World", "tokenize, ssplit", 1, 2, "5.00",
						"Text does not contain a distinct most frequent word", 1, 1 },

				// Test case #1
				{ 1, "", "Hello World!       Hello World.                Hello World?", "tokenize, ssplit", 1, 6,
						"5.00", "Text does not contain a distinct most frequent word", 1, 3 },
				...
				// Test case #3
				{ 1, "", "Hello World. World hello. Hello. World hello.", "tokenize, ssplit", 1, 7, "5.00", "hello", 1,
						4 },
				...
				// Test case #5
				{ 1, "", "Alex alex Alex Alex alex.", "tokenize, ssplit", 1, 5, "4.00", "alex", 1, 1 },
				...
				// Test case #7
				{ 2, "src/test/resources/TestData&Documentation/WordAnalysisTestFiles/WordAnalysis-TestCase6.txt", "",
						"tokenize, ssplit", 0, 23, "4.13", "i", 3, 3 },

				// Test case #8
				{ 2, "src/test/resources/TestData&Documentation/WordAnalysisTestFiles/WordAnalysis-TestCase7.txt", "",
						"tokenize, ssplit", 0, 12, "3.83", "is", 1, 1 },

				// Test case #9
				{ 2, "src/test/resources/TestData&Documentation/WordAnalysisTestFiles/WordAnalysis-TestCase8.txt", "",
						"tokenize, ssplit", 0, 128, "4.53", "the", 3, 6 },

				// Test case #10
				{ 1, "", "1234567890", "tokenize, ssplit", 0, 0, "0.00", "Text does not include any valid words", 0,
						0 },
