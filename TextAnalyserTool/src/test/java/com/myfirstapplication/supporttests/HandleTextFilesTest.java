...
public class HandleTextFilesTest {
	...
	public static Collection<Object[]> data() {
		return Arrays.asList(new Object[][] {
				...
				// Test case #0
				{ 1, "src/test/resources/TestData&Documentation/HandleTextFilesTestFiles/HandleTextFiles-TestCase0.txt",
						"Hello World", 1 },

				// Test case #1
				{ 1, "src/test/resources/TestData&Documentation/HandleTextFilesTestFiles/HandleTextFiles-TestCase1.txt",
						"Hello World. My name is Alex Owen. Whats your name?", 3 },

				// Test case #2
				{ 1, "src/test/resources/TestData&Documentation/HandleTextFilesTestFiles/HandleTextFiles-TestCase2.txt",
						"Hi there, How are you today. I am good thanks. How are you? I am well thankyou. Kind regards.",
						6 },

				// Test case #3
				{ 1, "src/test/resources/TestData&Documentation/HandleTextFilesTestFiles/HandleTextFiles-TestCase3.txt",
						"Hello World. My name is Alex Owen. Whats your name?", 3 },

				// Test case #4
				{ 2, "src/main/resources/AppInputData/POStags.txt",
						"{JJ=Adjective, " + "NN=Noun, " + "singular or mass, " + "WRB=Wh-adverb, "
								+ "LS=List item marker, " + "PRP=Personal pronoun, " + "DT=Determiner, "
								+ "FW=Foreign word, " + "NNP=Proper noun, singular, " + "JJS=Adjective, superlative, "
								+ "NNS=Noun, plural, " + "JJR=Adjective, comparative, " + "UH=Interjection, "
								+ "MD=Modal, " + "VBD=Verb, past tense, " + "WP=Wh-pronoun, "
								+ "VBG=Verb, gerund or present participle, " + "CC=Coordinating conjunction, "
								+ "CD=Cardinal number, " + "PDT=Predeterminer, " + "RBS=Adverb, superlative, "
								+ "RBR=Adverb, comparative, " + "VBN=Verb, past participle, "
								+ "IN=Preposition or subordinating conjunction, "
								+ "VBP=Verb, non-3rd person singular present, " + "SYM=Symbol, " + "WDT=Wh-determiner, "
								+ "NNPS=Proper noun, plural, " + "WP$=Possessive wh-pronoun, " + "VB=Verb, base form, "
								+ "VBZ=Verb, 3rd person singular present, " + "RB=Adverb, " + "EX=Existential there, "
								+ "PRP$=Possessive pronoun, " + "POS=Possessive ending, " + "TO=to, " + "RP=Particle}",
						0 }, });
	}
