...
public class SortValuesTest {
	 ...
	 * variables.
	 */
	public SortValuesTest(String referenceString, String values, int orderType, String expectedResult1,
	 ...
	 * both inputs to be passed into the relevent object and the expected results to
	 * be returned.
	 */
	@Parameters
	public static Collection<Object[]> data() {
		return Arrays.asList(new Object[][] {
				...
				{ "Hello, Hello, Hello, Hello, Hi, My, Name, Is, Alex, Hello, World",
						"10, 30, 20, 40, 2, 5, 9, 1, 8, 27, 21", 2, "[Hello, World, Name, Alex, My, Hi, Is]",
						"[27, 21, 9, 8, 5, 2, 1]" },

				// Test case #9
				{ "Hello, Hello, Hello, Hello, Hi, My, Name, Is, Alex, Hello, World",
						"10, 30, 20, 40, 2, 5, 9, 1, 8, 27, 21", 3, "[Is, Hi, My, Alex, Name, World, Hello]",
						"[1, 2, 5, 8, 9, 21, 27]" },
