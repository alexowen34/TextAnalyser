...
public class LanguageAnalysisTest 
{
	...
	public LanguageAnalysisTest(int testSelector, String fileLocation, String userInput, int decimalPlaces, String propertiesForNLP, int analysisOption, 
			...
			String expectedResult5, String expectedResult6, int expectedResult7, String expectedResult8)
	{
	...
	public static Collection<Object[]> data()
	{
		return Arrays.asList(new Object[][] {
			...
			//Test case #1
			{2,"Data/LanguageAnalysisTestFiles/LanguageAnalysis-TestCase1.txt", "", 0, "tokenize, ssplit, pos, parse, sentiment", 1, 0, 
			 "[Very positive, Positive, Neutral, Negative, Very negative]", "[My name is Alex Owen.]", "[Neutral]", "[0, 0, 1, 0, 0]",
			 "[0.00, 0.00, 100.00, 0.00, 0.00]", "[, , *, , ]", 1, "100.00"},
			...
			//Test case #3
			{2,"Data/LanguageAnalysisTestFiles/LanguageAnalysis-TestCase3.txt", "", 0, "tokenize, ssplit, pos, parse, sentiment", 1, 0, 
			 "[Very positive, Positive, Neutral, Negative, Very negative]", "[My name is Alex Owen.]", "[Neutral]", "[0, 0, 1, 0, 0]",
			 "[0.00, 0.00, 100.00, 0.00, 0.00]", "[, , *, , ]", 1, "100.00"},
			...
			//Test case #12
			{2,"Data/LanguageAnalysisTestFiles/LanguageAnalysis-TestCase12.txt", "",
		     0, "tokenize, ssplit, pos, parse, sentiment", 1, 0, "[Very positive, Positive, Neutral, Negative, Very negative]",
		     "[The service I received was outstanding!, It should be noted that the neighbours were really annoying., I have now returned home., I was throughly impressed on how comfortable the flight was - I'm so so happy with the quality!, I can't believe a 4 star hotel would serve this., Overall, I would this recommend travel company., All your employees should be proud., Sadly, I also have a complaint about the food... It was disgusting!, The flight took around 3 hours., Thanks, Alex Owen., It was incredibly dissapointing and I'm very very annoyed!, But this specific hotel resutrant should be avoided at all costs!, Please can this be passed on to the relevent people.]",
		     "[Very positive, Negative, Neutral, Very positive, Negative, Positive, Positive, Very negative, Neutral, Neutral, Very negative, Negative, Neutral]", 
		     "[2, 2, 4, 3, 2]", "[15.38, 15.38, 30.77, 23.08, 15.38]", "[**, **, ****, ***, **]", 13, "100.00"},
			...
			//Test case #15
			{2,"Data/LanguageAnalysisTestFiles/LanguageAnalysis-TestCase15.txt", "", 0, "tokenize, ssplit, pos, parse, sentiment", 2, 1, 
			 "[Wh-pronoun]", "[what, whom, who]", "[Wh-pronoun, Wh-pronoun, Wh-pronoun]", "[3]",
			 "[100.00]", "[***]", 3, "100.00"},

			//Test case #16
			{2,"Data/LanguageAnalysisTestFiles/LanguageAnalysis-TestCase16.txt", "", 0, "tokenize, ssplit, pos, parse, sentiment", 2, 1, 
			 "[Wh-determiner]", "[which, that, whatever]", "[Wh-determiner, Wh-determiner, Wh-determiner]", "[3]",
			 "[100.00]", "[***]", 3, "100.00"},
			
			//Test case #17
			{2,"Data/LanguageAnalysisTestFiles/LanguageAnalysis-TestCase17.txt", "", 0, "tokenize, ssplit, pos, parse, sentiment", 2, 1, 
			 "[Wh-adverb]", "[how, why, where, when]", "[Wh-adverb, Wh-adverb, Wh-adverb, Wh-adverb]", "[4]",
			 "[100.00]", "[****]", 4, "100.00"},
			
			//Test case #18
			{2,"Data/LanguageAnalysisTestFiles/LanguageAnalysis-TestCase18.txt", "", 0, "tokenize, ssplit, pos, parse, sentiment", 2, 1, 
			 "[Verb, past tense]", "[were, came, was, said, did]", "[Verb, past tense, Verb, past tense, Verb, past tense, Verb, past tense, Verb, past tense]", "[5]",
			 "[100.00]", "[*****]", 5, "100.00"},
			
			//Test case #19
			{2,"Data/LanguageAnalysisTestFiles/LanguageAnalysis-TestCase19.txt", "", 0, "tokenize, ssplit, pos, parse, sentiment", 2, 1, 
			...
			//Test case #20
			{2,"Data/LanguageAnalysisTestFiles/LanguageAnalysis-TestCase20.txt", "", 0, "tokenize, ssplit, pos, parse, sentiment", 2, 1, 
			...
			//Test case #21
			{2,"Data/LanguageAnalysisTestFiles/LanguageAnalysis-TestCase21.txt", "", 0, "tokenize, ssplit, pos, parse, sentiment", 2, 1, 
			...
			//Test case #22
			{2,"Data/LanguageAnalysisTestFiles/LanguageAnalysis-TestCase22.txt", "", 0, "tokenize, ssplit, pos, parse, sentiment", 2, 1, 
			 "[Verb, base form]", "[add, bode, die, be, prove]", "[Verb, base form, Verb, base form, Verb, base form, Verb, base form, Verb, base form]", "[5]",
			 "[100.00]", "[*****]", 5, "100.00"},
			
			//Test case #23
			{2,"Data/LanguageAnalysisTestFiles/LanguageAnalysis-TestCase23.txt", "", 0, "tokenize, ssplit, pos, parse, sentiment", 2, 1, 
			...
			//Test case #24
			{2,"Data/LanguageAnalysisTestFiles/LanguageAnalysis-TestCase24.txt", "", 0, "tokenize, ssplit, pos, parse, sentiment", 2, 1, 
			 "[to]", "[na, to, ta]","[to, to, to]", "[3]",
			 "[100.00]", "[***]", 3, "100.00"},
			
			//Test case #25
			{2,"Data/LanguageAnalysisTestFiles/LanguageAnalysis-TestCase25.txt", "", 0, "tokenize, ssplit, pos, parse, sentiment", 2, 1, 
			 "[Symbol]", "[|, \\, ¬, ~, _]","[Symbol, Symbol, Symbol, Symbol, Symbol]", "[5]",
			 "[100.00]", "[*****]", 5, "100.00"},
			
			//Test case #26
			{2,"Data/LanguageAnalysisTestFiles/LanguageAnalysis-TestCase26.txt", "", 0, "tokenize, ssplit, pos, parse, sentiment", 2, 1, 
			...
			//Test case #27
			{2,"Data/LanguageAnalysisTestFiles/LanguageAnalysis-TestCase27.txt", "", 0, "tokenize, ssplit, pos, parse, sentiment", 2, 1, 
			 "[Noun, plural]", "[appeals, israelians, forces, muslims, motorsports]","[Noun, plural, Noun, plural, Noun, plural, Noun, plural, Noun, plural]", "[5]",
			 "[100.00]", "[*****]", 5, "100.00"},
			
			//Test case #28
			{2,"Data/LanguageAnalysisTestFiles/LanguageAnalysis-TestCase28.txt", "", 0, "tokenize, ssplit, pos, parse, sentiment", 2, 1, 
			...
			//Test case #29
			{2,"Data/LanguageAnalysisTestFiles/LanguageAnalysis-TestCase29.txt", "", 0, "tokenize, ssplit, pos, parse, sentiment", 2, 1, 
			...
			//Test case #30
			{2,"Data/LanguageAnalysisTestFiles/LanguageAnalysis-TestCase30.txt", "", 0, "tokenize, ssplit, pos, parse, sentiment", 2, 1, 
			...
			//Test case #31
			{2,"Data/LanguageAnalysisTestFiles/LanguageAnalysis-TestCase31.txt", "", 0, "tokenize, ssplit, pos, parse, sentiment", 2, 1, 
			...
			//Test case #32
			{2,"Data/LanguageAnalysisTestFiles/LanguageAnalysis-TestCase32.txt", "", 0, "tokenize, ssplit, pos, parse, sentiment", 2, 1, 
			 "[Modal]", "[can, would, will, could, should]","[Modal, Modal, Modal, Modal, Modal]", "[5]",
			 "[100.00]", "[*****]", 5, "100.00"},
			
			//Test case #33
			{2,"Data/LanguageAnalysisTestFiles/LanguageAnalysis-TestCase33.txt", "", 0, "tokenize, ssplit, pos, parse, sentiment", 2, 1, 
			 "[Interjection]", "[hi, uh, eh, yes, hello]","[Interjection, Interjection, Interjection, Interjection, Interjection]", "[5]",
			 "[100.00]", "[*****]", 5, "100.00"},
			
			//Test case #34
			{2,"Data/LanguageAnalysisTestFiles/LanguageAnalysis-TestCase34.txt", "", 0, "tokenize, ssplit, pos, parse, sentiment", 2, 1, 
			 "[Foreign word]", "[c'est, etc, déjà, guerre, comme]","[Foreign word, Foreign word, Foreign word, Foreign word, Foreign word]", "[5]",
			 "[100.00]", "[*****]", 5, "100.00"},
			
			//Test case #35
			{2,"Data/LanguageAnalysisTestFiles/LanguageAnalysis-TestCase35.txt", "", 0, "tokenize, ssplit, pos, parse, sentiment", 2, 1, 
			 "[Determiner]", "[some, another, this, an, any]","[Determiner, Determiner, Determiner, Determiner, Determiner]", "[5]",
			 "[100.00]", "[*****]", 5, "100.00"},
			
			//Test case #36
			{2,"Data/LanguageAnalysisTestFiles/LanguageAnalysis-TestCase36.txt", "", 0, "tokenize, ssplit, pos, parse, sentiment", 2, 1, 
			...
			//Test case #37
			{2,"Data/LanguageAnalysisTestFiles/LanguageAnalysis-TestCase37.txt", "", 0, "tokenize, ssplit, pos, parse, sentiment", 2, 1, 
			...
			//Test case #38
			{2,"Data/LanguageAnalysisTestFiles/LanguageAnalysis-TestCase38.txt", "", 0, "tokenize, ssplit, pos, parse, sentiment", 2, 1, 
			 "[Adverb]", "[very, closely, currently, temporarily, soon]","[Adverb, Adverb, Adverb, Adverb, Adverb]", "[5]",
			 "[100.00]", "[*****]", 5, "100.00"},
			
			//Test case #39
			{2,"Data/LanguageAnalysisTestFiles/LanguageAnalysis-TestCase39.txt", "", 0, "tokenize, ssplit, pos, parse, sentiment", 2, 1, 
			...
			//Test case #40
			{2,"Data/LanguageAnalysisTestFiles/LanguageAnalysis-TestCase40.txt", "", 0, "tokenize, ssplit, pos, parse, sentiment", 2, 1, 
			...
			//Test case #41
			{2,"Data/LanguageAnalysisTestFiles/LanguageAnalysis-TestCase41.txt", "", 0, "tokenize, ssplit, pos, parse, sentiment", 2, 1, 
	...
	public void testSentiment() throws FileNotFoundException
	{
		if(analysisOption == 1)
		{
			...
			String result6 = Arrays.toString(test1.getSummaryBarChart());
			int result7 = test1.totalCount();		
			String result8 = round.format(test1.totalPercentage());
			...
			assertEquals(result5, expectedResult5);
			assertEquals(result6, expectedResult6);
			assertEquals(result7, expectedResult7);
			assertEquals(result8, expectedResult8);
		}
	}
	...
	public void testPOS() throws FileNotFoundException
	{
		if(analysisOption == 2)
		{
			...
			String result6 = Arrays.toString(test2.getSummaryBarChart());
			int result7 = test2.totalCount();
			String result8 = round.format(test2.totalPercentage());
