...
public class PartsOfSpeechAnalysisTest
{
	...
	public static Collection<Object[]> data()
	{
		return Arrays.asList(new Object[][] {
			...
			//Test case #0
			{2,"TestData&Documentation/LanguageAnalysisTestFiles/LanguageAnalysis-TestCase15.txt", "", 0, "tokenize, ssplit, pos", 1, 
			 "[Wh-pronoun]", "[what, whom, who]", "[Wh-pronoun, Wh-pronoun, Wh-pronoun]", "[3]",
			 "[100.00]", 3, "100.00"},

			//Test case #1
			{2,"TestData&Documentation/LanguageAnalysisTestFiles/LanguageAnalysis-TestCase16.txt", "", 0, "tokenize, ssplit, pos", 1, 
			 "[Wh-determiner]", "[which, that, whatever]", "[Wh-determiner, Wh-determiner, Wh-determiner]", "[3]",
			 "[100.00]", 3, "100.00"},
			
			//Test case #2
			{2,"TestData&Documentation/LanguageAnalysisTestFiles/LanguageAnalysis-TestCase17.txt", "", 0, "tokenize, ssplit, pos", 1, 
			 "[Wh-adverb]", "[how, why, where, when]", "[Wh-adverb, Wh-adverb, Wh-adverb, Wh-adverb]", "[4]",
			 "[100.00]", 4, "100.00"},
			
			//Test case #3
			{2,"TestData&Documentation/LanguageAnalysisTestFiles/LanguageAnalysis-TestCase18.txt", "", 0, "tokenize, ssplit, pos", 1, 
			 "[Verb, past tense]", "[were, came, was, said, did]", "[Verb, past tense, Verb, past tense, Verb, past tense, Verb, past tense, Verb, past tense]", "[5]",
			 "[100.00]", 5, "100.00"},
			
			//Test case #4
			{2,"TestData&Documentation/LanguageAnalysisTestFiles/LanguageAnalysis-TestCase19.txt", "", 0, "tokenize, ssplit, pos", 1, 
			...
			//Test case #5
			{2,"TestData&Documentation/LanguageAnalysisTestFiles/LanguageAnalysis-TestCase20.txt", "", 0, "tokenize, ssplit, pos", 1, 
			...
			//Test case #6
			{2,"TestData&Documentation/LanguageAnalysisTestFiles/LanguageAnalysis-TestCase21.txt", "", 0, "tokenize, ssplit, pos", 1, 
			...
			//Test case #7
			{2,"TestData&Documentation/LanguageAnalysisTestFiles/LanguageAnalysis-TestCase22.txt", "", 0, "tokenize, ssplit, pos", 1, 
			 "[Verb, base form]", "[add, bode, die, be, prove]", "[Verb, base form, Verb, base form, Verb, base form, Verb, base form, Verb, base form]", "[5]",
			 "[100.00]", 5, "100.00"},
			
			//Test case #8
			{2,"TestData&Documentation/LanguageAnalysisTestFiles/LanguageAnalysis-TestCase23.txt", "", 0, "tokenize, ssplit, pos", 1, 
			...
			//Test case #9
			{2,"TestData&Documentation/LanguageAnalysisTestFiles/LanguageAnalysis-TestCase24.txt", "", 0, "tokenize, ssplit, pos", 1, 
			 "[to]", "[na, to, ta]","[to, to, to]", "[3]",
			 "[100.00]", 3, "100.00"},
			
			//Test case #10
			{2,"TestData&Documentation/LanguageAnalysisTestFiles/LanguageAnalysis-TestCase25.txt", "", 0, "tokenize, ssplit, pos", 1, 
			 "[Symbol]", "[|, \\, ¬, ~, _]","[Symbol, Symbol, Symbol, Symbol, Symbol]", "[5]",
			 "[100.00]", 5, "100.00"},
			
			//Test case #11
			{2,"TestData&Documentation/LanguageAnalysisTestFiles/LanguageAnalysis-TestCase26.txt", "", 0, "tokenize, ssplit, pos", 1, 
			...
			//Test case #12
			{2,"TestData&Documentation/LanguageAnalysisTestFiles/LanguageAnalysis-TestCase27.txt", "", 0, "tokenize, ssplit, pos", 1, 
			 "[Noun, plural]", "[appeals, israelians, forces, muslims, motorsports]","[Noun, plural, Noun, plural, Noun, plural, Noun, plural, Noun, plural]", "[5]",
			 "[100.00]", 5, "100.00"},
			
			//Test case #13
			{2,"TestData&Documentation/LanguageAnalysisTestFiles/LanguageAnalysis-TestCase28.txt", "", 0, "tokenize, ssplit, pos", 1, 
			...
			//Test case #14
			{2,"TestData&Documentation/LanguageAnalysisTestFiles/LanguageAnalysis-TestCase29.txt", "", 0, "tokenize, ssplit, pos", 1, 
			...
			//Test case #15
			{2,"TestData&Documentation/LanguageAnalysisTestFiles/LanguageAnalysis-TestCase30.txt", "", 0, "tokenize, ssplit, pos", 1, 
			...
			//Test case #16
			{2,"TestData&Documentation/LanguageAnalysisTestFiles/LanguageAnalysis-TestCase31.txt", "", 0, "tokenize, ssplit, pos", 1, 
			...
			//Test case #17
			{2,"TestData&Documentation/LanguageAnalysisTestFiles/LanguageAnalysis-TestCase32.txt", "", 0, "tokenize, ssplit, pos", 1, 
			 "[Modal]", "[can, would, will, could, should]","[Modal, Modal, Modal, Modal, Modal]", "[5]",
			 "[100.00]", 5, "100.00"},
			
			//Test case #18
			{2,"TestData&Documentation/LanguageAnalysisTestFiles/LanguageAnalysis-TestCase33.txt", "", 0, "tokenize, ssplit, pos", 1, 
			 "[Interjection]", "[hi, uh, eh, yes, hello]","[Interjection, Interjection, Interjection, Interjection, Interjection]", "[5]",
			 "[100.00]", 5, "100.00"},
			
			//Test case #19
			{2,"TestData&Documentation/LanguageAnalysisTestFiles/LanguageAnalysis-TestCase34.txt", "", 0, "tokenize, ssplit, pos", 1, 
			 "[Foreign word]", "[c'est, etc, déjà, guerre, comme]","[Foreign word, Foreign word, Foreign word, Foreign word, Foreign word]", "[5]",
			 "[100.00]", 5, "100.00"},
			
			//Test case #20
			{2,"TestData&Documentation/LanguageAnalysisTestFiles/LanguageAnalysis-TestCase35.txt", "", 0, "tokenize, ssplit, pos", 1, 
			 "[Determiner]", "[some, another, this, an, any]","[Determiner, Determiner, Determiner, Determiner, Determiner]", "[5]",
			 "[100.00]", 5, "100.00"},
			
			//Test case #21
			{2,"TestData&Documentation/LanguageAnalysisTestFiles/LanguageAnalysis-TestCase36.txt", "", 0, "tokenize, ssplit, pos", 1, 
			...
			//Test case #22
			{2,"TestData&Documentation/LanguageAnalysisTestFiles/LanguageAnalysis-TestCase37.txt", "", 0, "tokenize, ssplit, pos", 1, 
			...
			//Test case #23
			{2,"TestData&Documentation/LanguageAnalysisTestFiles/LanguageAnalysis-TestCase38.txt", "", 0, "tokenize, ssplit, pos", 1, 
			 "[Adverb]", "[very, closely, currently, temporarily, soon]","[Adverb, Adverb, Adverb, Adverb, Adverb]", "[5]",
			 "[100.00]", 5, "100.00"},
			
			//Test case #24
			{2,"TestData&Documentation/LanguageAnalysisTestFiles/LanguageAnalysis-TestCase39.txt", "", 0, "tokenize, ssplit, pos", 1, 
			...
			//Test case #25
			{2,"TestData&Documentation/LanguageAnalysisTestFiles/LanguageAnalysis-TestCase40.txt", "", 0, "tokenize, ssplit, pos", 1, 
			...
			//Test case #26
			{2,"TestData&Documentation/LanguageAnalysisTestFiles/LanguageAnalysis-TestCase41.txt", "", 0, "tokenize, ssplit, pos", 1, 
