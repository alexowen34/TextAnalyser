...
public class NLPpipeline {
	...
	/* 
	 * Constructor method that is used by WordAnalysis and LanguageAnalysis objects
	 * to pass in required data to this object.
	 */
	...
	/*
	 * This method passes in the properties to the StanfordCoreNLP object that have
	 * been passed into the constructor method. It then returns the StanfordCoreNLP
	 * object with the properties loaded it to it.
	 */
