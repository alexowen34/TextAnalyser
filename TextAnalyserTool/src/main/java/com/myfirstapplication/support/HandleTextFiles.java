...
public class HandleTextFiles {
	...
	/* 
	 * Constructor method that obtains the file name/location and stores this in
	 * private String variable 'location'.
	 */
	...
	/*
	 * This method extracts the content across all lines of the given txt file into
	 * a single String variable. It also counts the number of lines (that contains
	 * content) in the text file therefore returning the number of paragraphs.
	 */
	...
	/* 
	 * This method gets the POS tags and descriptions from the hard coded file
	 * location txt file and puts them into a HashMap.
	 */
	...
	/* 
	 * Allows the user to access the String that has been populated with the txt
	 * file content in 'fileToString' method.
	 */
