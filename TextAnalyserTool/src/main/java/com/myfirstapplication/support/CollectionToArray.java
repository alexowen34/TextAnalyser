...
public class CollectionToArray {
	...
	/* 
	 * Constructor method that is used to collect a Map of type string for it's keys
	 * and of type integer for it's values.
	 */
	...
	/* 
	 * Constructor method that is used to collect a HashMap of type string both for
