...
public class SortValues {
	...
	/*
	 * Constructor method that is used by CharacterAnalysis class and
	 * 'partsOfSpeechAnalsis' method within the LanguageAnalysis class to pass in
	 * required data to this object.
	 */
	...
	/*
	 * Populates HashMap with reference string and count/values array. Calls
	 * sortByValue method to sort HashMap using a LinkedList and the Comparator
	 * function to do a Collections.sort in either DESC or ASC order depending on
	 * user option. It then returns the HashMap in the specified sorted order by
	 * using a LinkedHashMap to maintain the sorted insertion order.
	 */
	...
	/* 
	 * Private method that is called from 'StringIntArrayToSortedHashMap' method -
	 * see comments above this method for more detail.
	 */
