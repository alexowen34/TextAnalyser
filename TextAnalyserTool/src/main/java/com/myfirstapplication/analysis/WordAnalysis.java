...
public class WordAnalysis extends TextToBeAnalysed {
	...
	/*
	 * Contructor method that is used by the GUI to pass in requried data to this
	 * object.
	 */
	...
	/*
	 * Contructor method that is used by the WordAnalysisTest class in order to pass
	 * the users input to the abstract 'TextToBeAnalysed' class.
	 */
	...
	/*
	 * Constructor method that is used by sentimentAnalysis method in
	 * LanguageAnalysis object to pass in required data to this object. It passes
	 * the usersInput to the textToBeAnalysed variable in the abstract class as this
	 * needs to happen for the test to run successfully otherwise it woulden't be
	 * stored in memory.
	 */
	...
	/*
	 * Turns users input into a String array removing any spaces in the String. Then
	 * removes any special characters or numbers from String array - this is
	 * important for when averageWordLength is calculated in a later method. This
	 * method then counts the number of indexes in the String therefore returning
	 * the number of words.
	 */
	...
	/*
	 * This method calculates the average number of letters per word by calculating
	 * the sum of letters in 'wordArray' and dividing it by the total number of
	 * words. Special characters and numbers are removed from any words in the
	 * 'wordCount' method as these will impact the accurary of the average word
	 * length i.e. if there's a full stop at the end of a sentence this would have
	 * counted towards the length of a word.
	 */
	...
	/*
	 * This method calculates the most frequency word. It returns the most frequent
	 * word if it is 'greater than' the count of others words rather than 'equal to
	 * and greater than'. If there are two or more different words with the same
	 * highest frequency then an information message will be printed out as the
	 * result. An information message will also be printed out if there are no valid
	 * words.
	 */
	...
	/*
	 * This method finds the number of sentences using the StanfordCoreNLP library.
	 * This library is brought in to my Maven project through the POM.xml file where
	 * it is listed as a dependency.
	 */
	...
	/*
	 * This method returns the sentence count. Method is used in this project only
	...
	/*
	 * Used to create the ObservableList that stores the word analysis results for
	 * the table.
	 */
