...
public class LanguageAnalysis extends TextToBeAnalysed {
	...
	/*
	 * Constructor method that is used by GUI to pass in required data to this
	 * object
	 */
	public LanguageAnalysis(String propertiesForNLP, int analysisOption, int sortingOptionType) {
	...
	/*
	 * Contructor method that is used by the LanguageAnalysisTest class in order to
	 * pass the users input to the abstract 'TextToBeAnalysed' class.
	 */
	...
	/* 
	 * Contructor method that is used soley for GUI table creation (Sentiment
	 * analysis)
	 */
	...
	/*
	 * This method returns the sentiments and the unique sentences they belong to.
	 * Sentiment analysis is calculated using StanfordCoreNLP libary. It puts the
	 * sentiments and unique sentences into an array so it can be printed out in the
	 * 'toTable' method. Finally, the method then passes the required data into the
	 * 'summary' method to create a overall summary of which sentiments have been
	 * observed.
	 */
	...
	/*
	 * This method returns the different types of sentiment. It is used in this
	...
	/* This method returns the distinct sentences the user has inputted. It is used
	 * in this project only for testing purposes.
	 */
	...
	/*
	 * This method returns the sentiment of each distinct sentence the user has
	 * inputted. It is used in this project only for testing purposes.
	 */
	...
	/*
	 * This method returns the parts of speech (POS) analysis (i.e. nouns,
	 * adjectives, adverbs using the StanfordCoreNLP libary) and each unique word
	 * (as HashMap removes duplicate keys/words).POS tags are transformed into
	 * descriptions which are contained in the POStags.txt file. Finally, the method
	 * then passes the required data into the 'summary' method to create a overall
	 * summary of which POS descriptions have been observed.
	 */
	...
	/* 
	 * This method returns the distinct POS tags. It is used in this project only
	...
	/* 
	 * This method returns the distinct words the user has inputted. It is used in
	...
	/*
	 * This method returns the POS tags related to the distinct words the user has
	 * inputted. It is used in this project only for testing purposes.
	 */
	...
	/*
	 * This method returns the required data (count, percentage and chart) to create
	 * a summary for both the POS and sentiment analysis. For POS analysis in
	 * particular, it sorts the values in DESC or ASC order depending on what the
	 * user selects in GUI menu option. Sentiment analysis is not sorted as the
	 * number of sentiment categories/descriptions is fixed and sequential i.e. Very
	 * positive, Positive etc. so it make sense to keep in hard coded order to make
	 * summary easier to read for user.
	 */
	...
	/*
	 * This method returns the count array for the summary table. It is used in this
	 * project only for testing purposes.
	 */
	...
	/*
	 * This method returns the percentage array for the summary table. It is used in
	 * this project only for testing purposes.
	 */
	 ...
	 * It is used in this project only for testing purposes.
	 */
	...
	/*
	 * This method returns the total percentage/relative frequency for the choosen
	 * analysis type. It is used in this project only for testing purposes.
	 */
	...
	public ObservableList<Data> pieChartData() {
		CreatePieChartData populatePieChartData = new CreatePieChartData(rowDescription, summaryPercentage,
				summaryCount);
	...
	/*
	 * Used to create the ObservableList for either the senitment or parts of speech
	 * analysis tables.
	 */
	private ObservableList<LanguageAnalysis> createTableData(String label[], String value[], String type) {
		...
		for (int i = 0; i < label.length; i++) {
			switch (type) {
			case "Sentiment":
				data.add(new LanguageAnalysis(label[i], value[i]));
				break;
			case "POS":
				data.add(new LanguageAnalysis(label[i], value[i], ""));
				break;
