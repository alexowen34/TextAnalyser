...
public class CharacterAnalysis extends TextToBeAnalysed {
	...
	*/
	...
	/*
	 * Constructor method that is shortened for 'relativeCharFrequencies' and
	 * 'summary' method that is created and called from within this class.
	 */
	...
	/*
	 * This method is called from 'countCharFrequencies' method - see comments in
	 * this method for more detail.
	 */
	...
	/*
	 * This method counts the number of filtered characters. It makes multiple calls
	 * to timesCharOccurs method, via a loop, to see if individual filtered
	 * characters match the individual characters in users text input and if so, how
	 * many times they occur. If user has selected to sort the results, then this
	 * method will create a new instance of 'SortValues' class to fulfill the
	 * sorting requirement. It's worth noting that it is passing in the reference
	 * characters to the SortValues object as a string array rather than char array
	 * to save duplicate code in the SortValues object as the LanguageAnalysis class
	 * needs to pass in reference values as string array. These reference characters
	 * are later transformed back into a char array to it's global variable.
	 */
	...
	/*
	 * This method returns the reference characters for the table. It is used in
	...
	/*
	 * Method returns either the percentage of how often the characters occur in
	 * just the filtered string (i.e. if user has selected to filter by only
	 * letters, numbers or specical characters) or the full string entered. User has
	 * the option to select between these two calculations in GUI. This method is
	 * dependant on countCharFrequencies method being ran first so that the relevent
	...
	/*
	 * This method creates a summary by totaling the number of letters, numbers and
	 * special characters and returns a total count and percentage. Results are only
	 * allowed to be displayed in GUI when 'Include all characters' is selected as
	 * this is the only filter option where the summary would be useful.
	 */
	public void summary() {
	...
	/*
	 * This method returns the row values for the summary chart. Method is used in
	 * this project only for testing purposes.
	 */
	...
	/*
	 * This method returns the percentage for the summary chart. Method is used in
	 * this project only for testing purposes.
	 */
	...
	/*
	 * This method returns the bar chart data using the variables populated in this
	 * class.
	 */
	...
	/*
	 * This method gets called in the for loop in the barChartData method. This
	 * method returns the data with data labels for each bar.
	 */
