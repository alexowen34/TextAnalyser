...
public class GUI extends Application {
	...
	private void setupBottomButtons() {
		...
		// Set bottom buttons to the same pref height, width and font size
	...
	private void addIconsToButtons(String[] filePaths) {
		...
		for (int i = 0; i < arrayOfBottomButtons.length; i++) {
			...
			if (i != 2 && i != 3) {
				...
				view[i].setFitHeight(22);
				view[i].setFitWidth(23);
				if (filePaths[i].contains("SortASC") || filePaths[i].contains("SortDESC")) {
					view[i].setFitHeight(22);
					view[i].setFitWidth(24);
				}
	...
	private void setupLabels() {
		...
		applicationHeader.setPrefHeight(66);
		applicationHeader.setPrefWidth(743);
		applicationHeader.setStyle("-fx-font-size: 28px");
		applicationHeader.setAlignment(Pos.CENTER);
		applicationHeader.setText("Text Analyser");

		or.setLayoutX(36);
		or.setLayoutY(187);
		or.setStyle("-fx-font-size: 14px");
		or.setText("OR");

		displayInputMethodHeader.setLayoutX(36);
		displayInputMethodHeader.setLayoutY(100);
		displayInputMethodHeader.setStyle(labelFontSize);
		displayInputMethodHeader.setText("Please select your text import method:");

		displayAnalysisTypeHeader.setLayoutX(36);
		displayAnalysisTypeHeader.setLayoutY(297);
		...
		importFileSuccessMessage.setLayoutX(167);
		importFileSuccessMessage.setLayoutY(148);
		...
		displayTextHeader.setLayoutX(36);
		displayTextHeader.setLayoutY(422);
		displayTextHeader.setStyle(labelFontSize);
		displayTextHeader.setText("Here is your text:");

		characterBarChartHeader.setLayoutX(36);
		characterBarChartHeader.setLayoutY(589);
		characterBarChartHeader.setPrefHeight(21);
		characterBarChartHeader.setPrefWidth(673);
		...
		sentimentResultsHeader.setLayoutX(36);
		sentimentResultsHeader.setLayoutY(589);
		sentimentResultsHeader.setPrefHeight(21);
		sentimentResultsHeader.setPrefWidth(673);
		...
		wordAnalysisResultsHeader.setLayoutX(36);
		wordAnalysisResultsHeader.setLayoutY(589);
		wordAnalysisResultsHeader.setPrefHeight(21);
		wordAnalysisResultsHeader.setPrefWidth(673);
		...
		partsOfSpeechAnalysisResultsHeader.setLayoutX(36);
		partsOfSpeechAnalysisResultsHeader.setLayoutY(589);
		partsOfSpeechAnalysisResultsHeader.setPrefHeight(21);
		partsOfSpeechAnalysisResultsHeader.setPrefWidth(673);
		...
		characterPieChartHeader.setLayoutX(36);
		characterPieChartHeader.setLayoutY(589);
		characterPieChartHeader.setPrefHeight(21);
		characterPieChartHeader.setPrefWidth(673);
	...
	private void setupCharts() {
		characterAnalysisPieChart.setLayoutX(36);
		characterAnalysisPieChart.setLayoutY(617);
		characterAnalysisPieChart.setPrefHeight(278);
		characterAnalysisPieChart.setPrefWidth(673);
		characterAnalysisPieChart.setStyle(button_Chart_Table_ComboBox_Other_FontSize);

		characterAnalysisBarChart.setLayoutX(18);
		characterAnalysisBarChart.setLayoutY(616);
		characterAnalysisBarChart.setPrefHeight(286);
		characterAnalysisBarChart.setPrefWidth(701);
		characterAnalysisBarChart.setStyle(button_Chart_Table_ComboBox_Other_FontSize);

		sentimentAnalysisPieChart.setLayoutX(36);
		sentimentAnalysisPieChart.setLayoutY(617);
		sentimentAnalysisPieChart.setPrefHeight(278);
		sentimentAnalysisPieChart.setPrefWidth(673);
		sentimentAnalysisPieChart.setStyle(button_Chart_Table_ComboBox_Other_FontSize);
	}

	@SuppressWarnings("unchecked")
	private void setupTables() {
		sentimentAnalysisTable.setLayoutX(36);
		sentimentAnalysisTable.setLayoutY(631);
		sentimentAnalysisTable.setPrefHeight(250);
		sentimentAnalysisTable.setPrefWidth(673);
		sentimentAnalysisTable.setStyle(button_Chart_Table_ComboBox_Other_FontSize);
		sentiment.setPrefWidth(118);
		sentence.setPrefWidth(554);
		sentiment.setText("Senitment");
		sentence.setText("Sentence");
		sentimentAnalysisTable.getColumns().addAll(sentiment, sentence);

		wordAnalysisTable.setLayoutX(36);
		wordAnalysisTable.setLayoutY(631);
		wordAnalysisTable.setPrefHeight(250);
		wordAnalysisTable.setPrefWidth(673);
		wordAnalysisTable.setStyle(button_Chart_Table_ComboBox_Other_FontSize);
		metric.setPrefWidth(179);
		value.setPrefWidth(493);
		metric.setText("Metric");
		value.setText("Value");
		wordAnalysisTable.getColumns().addAll(metric, value);

		partsOfSpeechAnalysisTable.setLayoutX(36);
		partsOfSpeechAnalysisTable.setLayoutY(631);
		partsOfSpeechAnalysisTable.setPrefHeight(250);
		partsOfSpeechAnalysisTable.setPrefWidth(673);
		partsOfSpeechAnalysisTable.setStyle(button_Chart_Table_ComboBox_Other_FontSize);
		POStag.setPrefWidth(179);
		word.setPrefWidth(493);
		POStag.setText("Parts of Speech");
		word.setText("Word");
		partsOfSpeechAnalysisTable.getColumns().addAll(POStag, word);
	}

	private void setupComboBoxs() {
		filteringOptionsBox.setLayoutX(318);
		filteringOptionsBox.setLayoutY(533);
		filteringOptionsBox.setPrefHeight(31);
		filteringOptionsBox.setPrefWidth(163);
		filteringOptionsBox.setPromptText("Filter Characters:");
		filteringOptionsBox.getItems().addAll("All characters", "Only letters", "Only numbers",
		...
		percentageOptionsBox.setLayoutX(497);
		percentageOptionsBox.setLayoutY(533);
		percentageOptionsBox.setPrefHeight(31);
		percentageOptionsBox.setPrefWidth(210);
	...
	private void setupRectangles() {
		...
		inputBackgroundBox.setHeight(193);
		inputBackgroundBox.setWidth(743);
		inputBackgroundBox.setStyle("-fx-fill: #eaeaea");

		analysisBackgroundBox.setLayoutY(401);
		analysisBackgroundBox.setHeight(504);
		analysisBackgroundBox.setWidth(743);
		analysisBackgroundBox.setStyle("-fx-fill: #eaeaea");
	}

	private void setupOther() {
		darkModeActivate.setText("Dark Mode");
		darkModeActivate.setLayoutX(599);
		darkModeActivate.setLayoutY(27);
		darkModeActivate.setPrefHeight(20);
		darkModeActivate.setPrefWidth(110);
		darkModeActivate.setStyle(button_Chart_Table_ComboBox_Other_FontSize);

		textForAnalysis.setLayoutX(35);
		textForAnalysis.setLayoutY(221);
		textForAnalysis.setPrefHeight(31);
		textForAnalysis.setPrefWidth(673);
		textForAnalysis.setPromptText("Enter text");
		textForAnalysis.setStyle(button_Chart_Table_ComboBox_Other_FontSize);

		displayText.setLayoutX(36);
		displayText.setLayoutY(467);
		displayText.setPrefHeight(47);
		displayText.setPrefWidth(673);
	...
	private boolean emptyTextError() {
		 ...
		 * undertaken without any text present.
		 */
		if (textToBeAnalysed.isEmpty()) {
	...
	private void displayCharacterAnalysis(ActionEvent event) {
		...
		if (emptyTextError()) {
			...
			/*
			 * This method call is important to re-set the layout of the bar chart to ensure
			 * that it doesn't remain the same if the user selects the bar chart in either
			 * ASC or DESC order.
			 */
	...
	private void displaySentimentAnalysis(ActionEvent event) {
		...
		if (emptyTextError()) {
			...
			/*
			 * for loop sets the colour of the sentiment labels on the pie chart i.e. very
			 * positive = dark green, positive = green, neutral = amber, negative = red,
	...
	private void percentageCalculation(ActionEvent event) {
		...
		case "Only the filtered characters":
			percentageCalculation = 1;
			break;
		case "All types of characters":
			percentageCalculation = 2;
			break;
		}
		displayCharacterAnalysis(event);
	}
